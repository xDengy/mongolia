...
<?=bitrix_sessid_post()?>
<div class="adm-detail-title-view-tab"><?=Loc::getMessage('DOLYAME.PAYMENT_SELECT_REFUND_POSITION')?></div>
...
<table class="adm-list-table">
	<thead>
		<tr class="adm-list-table-header">
			...
			<td class="adm-list-table-cell"><div class="adm-list-table-cell-inner">
				<strong><?=Loc::getMessage('DOLYAME.PAYMENT_REFUND_POSITION_NAME')?></strong>
			</div></td>
			<td class="adm-list-table-cell"><div class="adm-list-table-cell-inner">
				<strong><?=Loc::getMessage('DOLYAME.PAYMENT_REFUND_POSITION_QUANTITY')?></strong>
			</div></td>
			<td class="adm-list-table-cell"><div class="adm-list-table-cell-inner">
				<strong><?=Loc::getMessage('DOLYAME.PAYMENT_REFUND_POSITION_PRICE')?></strong>
			</div></td>
		</tr>
	</thead>
	<tbody>
	...
	<tr class="adm-list-table-row">
		<td class="adm-list-table-cell" colspan="3"><?=Loc::getMessage('DOLYAME.PAYMENT_REFUND_SUM')?></td>
