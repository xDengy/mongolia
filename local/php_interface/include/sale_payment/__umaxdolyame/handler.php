...
use ST\Payments\DolyameClass;

//Loc::loadMessages(__FILE__);

class UmaxDolyameHandler extends PaySystem\ServiceHandler // implements PaySystem\IRefund //, PaySystem\IHold
{
    public function initiatePay(Payment $payment, Request $request = null)
    {
        ...
        try {
            $dolyameClass = new DolyameClass();

            $dolyameRes = $dolyameClass->registerOrderInDolyame(
                $payment,
                $propUserEmail
            );
        } catch (\Exception $e) {
        ...
        $result->setPaymentUrl($dolyameRes['formUrl']);
