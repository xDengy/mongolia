...
Asset::getInstance()->addCss(SITE_TEMPLATE_PATH."/assets/css/pages/delivery.css");
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"PROPERTY_CODE" => array("H2", "H2_TEXT", "PHONE", "WORK_TIME", "PRICE_TITLE", "PRICE_TEXT", "TEXT", "PAYMENT_TEXT", "COURIER_TEXT", ""),
		"SET_BROWSER_TITLE" => "N",
		"SET_CANONICAL_URL" => "N",
		"SET_LAST_MODIFIED" => "N",
